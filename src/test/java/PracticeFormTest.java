...
//      Apas butonul Submit
        ...
        expectedValues.put("Hobbies", sportHobbysText + ", " + readingHobbysText + ", " + musicHobbysText);
        expectedValues.put("Picture", pictureFileTest);
        expectedValues.put("Adress", adressValueText);
        ...
        for (int i = 0; 1 < submitTableValues.size(); i++) {
