...
import static constatnts.MenuConstants.FORMS_MENU;
import static constatnts.SubMenuConstants.PRACTICE_FORM_SUBMENU;
...
public class PracticeFormTest extends BaseTest {
    ...
    public void practiceFormTest() {
        ...
        Map<String, Object> formData = loadFormData("inputData/PracticeFormTestData.properties");
        practiceFormPage.fillEntireForm(formData);
        practiceFormPage.getExpectedValues(formData);
        practiceFormPage.getActualValues();
        practiceFormPage.validateThatExpectedValuesEqualActualValues(formData);
